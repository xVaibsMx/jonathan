  ...
  return (
    ...
    >
      <header className="text-center mb-16">
        <h2 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-purple-700 font-mono tracking-wide">
          ArtWorks
        </h2>
        <p className="text-lg sm:text-xl md:text-2xl font-light mt-4 text-blue-400 max-w-xl mx-auto leading-relaxed">
      ...
      >
        {artWorks.map((art, index) => (
          ...
          >
            <article className="relative w-full max-w-sm mx-auto aspect-[3/4] bg-black/25 rounded-3xl shadow-lg shadow-purple-700/40 overflow-hidden group transition-transform duration-500 ease-in-out hover:scale-[1.03]">
              <img
                src={art.img}
                alt={art.Name}
                loading="lazy"
